...
public class SecurityService {
    ...
    private static final String READ_SCOPE = "SCOPE_reservation:read";
    private static final String WRITE_SCOPE = "SCOPE_reservation:write";
    private static final String API_READ_SCOPE = "SCOPE_reservation:api:read";

    public Mono<Boolean> canCreateReservation() {
    ...
    public Mono<Boolean> canChangeReservationStatus(UUID reservationId) {
